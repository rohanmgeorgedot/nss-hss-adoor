    ...
    <div className="w-full">
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8 lg:px-16">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="relative" data-aos="fade-right">
                ...
                <div className="space-y-4">
                  ...
                  <div className="overflow-hidden rounded-2xl">
                    <Image
                      ...
                      width={300}
                      height={250}
                      className="h-36 w-full object-cover transition-transform duration-500 hover:scale-105 md:h-48"
                    />
                  </div>
                </div>
              ...
              {/* Experience Badge */}
              <div className="absolute -bottom-6 -right-4 rounded-2xl bg-primary p-4 text-white shadow-xl md:p-6">
                <p className="text-3xl font-bold md:text-4xl">90+</p>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <p className="text-2xl font-bold text-font-primary md:text-3xl">{stat.value}</p>
                <p className="text-sm text-font-secondary">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <h3 className="mb-2 text-lg font-bold text-font-primary">{milestone.title}</h3>
                <p className="text-sm text-font-secondary">{milestone.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 md:px-8 lg:px-16">
          ...
          <div className="rounded-2xl bg-gray-50 p-6 md:p-8" data-aos="fade-up">
            <p className="text-center text-base leading-relaxed text-font-secondary md:text-lg">
